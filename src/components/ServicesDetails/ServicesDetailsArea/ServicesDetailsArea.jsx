                      ...
                      >
                        <defs>
                          <clipPath id='recharts1-clip'>
                            <rect x={60} y={10} height={260} width={586} />
                          </clipPath>
                        </defs>
                          ...
                          <g className='recharts-cartesian-axis-ticks'>
                            ...
                            <g className='recharts-layer recharts-cartesian-axis-tick'>
                              ...
                              <text
                                ...
                                textAnchor='middle'
                              >
                                <tspan x='157.66666666666669' dy='0.71em'>
                                  Page B
                                </tspan>
                              </text>
                            </g>
                            <g className='recharts-layer recharts-cartesian-axis-tick'>
                              ...
                              <text
                                ...
                                textAnchor='middle'
                              >
                                <tspan x='255.33333333333334' dy='0.71em'>
                                  Page C
                                </tspan>
                              </text>
                            </g>
                            ...
                            <g className='recharts-layer recharts-cartesian-axis-tick'>
                              ...
                              <text
                                ...
                                textAnchor='middle'
                              >
                                <tspan x='450.6666666666667' dy='0.71em'>
                                  Page E
                                </tspan>
                              </text>
                            </g>
                          ...
                          <g className='recharts-layer'>
                            <defs>
                              <clipPath id='animationClipPath-recharts-area-2'>
                                <rect x={60} y={0} width={586} height={271} />
                              </clipPath>
                            </defs>
                            <g
                            ...
                            >
                              <g className='recharts-layer'>
                                <path
                                  ...
                                  d='M60,205C92.55555555555557,210.41666666666666,125.11111111111111,215.83333333333334,157.66666666666669,221.25C190.22222222222223,226.66666666666666,222.7777777777778,237.5,255.33333333333334,237.5C287.8888888888889,237.5,320.44444444444446,224.82500000000002,353,224.82500000000002C385.55555555555554,224.82500000000002,418.11111111111114,239.2875,450.6666666666667,239.2875C483.22222222222223,239.2875,515.7777777777778,235.49583333333334,548.3333333333334,231.1625C580.8888888888889,226.82916666666665,613.4444444444445,220.05833333333334,646,213.2875L646,270C613.4444444444445,270,580.8888888888889,270,548.3333333333334,270C515.7777777777778,270,483.22222222222223,270,450.6666666666667,270C418.11111111111114,270,385.55555555555554,270,353,270C320.44444444444446,270,287.8888888888889,270,255.33333333333334,270C222.7777777777778,270,190.22222222222223,270,157.66666666666669,270C125.11111111111111,270,92.55555555555557,270,60,270Z'
                                />
                                <path
                                  type='monotone'
                                  stroke='#8884d8'
                          ...
                          <g className='recharts-layer'>
                            <defs>
                              <clipPath id='animationClipPath-recharts-area-3'>
                                <rect x={60} y={0} width={586} height={240} />
                              </clipPath>
                            </defs>
                            <g
                              className='recharts-layer'
                          ...
                          <g className='recharts-layer'>
                            <defs>
                              <clipPath id='animationClipPath-recharts-area-4'>
                                <rect x={60} y={0} width={586} height={199} />
                              </clipPath>
                            </defs>
                            <g
                              className='recharts-layer'
